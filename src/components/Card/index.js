...
import stylesCard from './card.scss'
console.log(stylesCard)

const Card = ({ title, img, price, onClickFavourite, onClickPlus }) => {
	...
	return (
		<div className="card">
			<div className="card__img">
				<button className="card-favourite button-action" onClick={onClickFavourite}>
			...
			<div className="card__content">
				...
				<div className="card__price price-card">
					<div className="price-card__body">
						...
						<div className="price-card__cost">{price} руб.</div>
					</div>
					<button className="price-card__plus button-action" onClick={addToBasket} style={isAdded ? { background: 'linear-gradient(180deg, #89F09C 0%, #3CC755 100%)' } : { background: 'transparent' }}>

						<svg style={isAdded ? { display: 'none' } : { display: 'block' }} width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<svg style={isAdded ? { display: 'block' } : { display: 'none' }} width="12" height="11" viewBox="0 0 12 11" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<defs>
								<filter id="filter0_d_60_204" x="0.666534" y="0.329834" width="10.6698" height="10.5132" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
